      ...
      <section className="animate-fade-up">
        ...
        <div className="smarty-card divide-y divide-border p-2">
          <Link
            ...
            className="flex items-center gap-3 px-3 py-3.5 transition-smooth active:scale-[0.99]"
          >
            ...
            <span className="min-w-0 flex-1">
              ...
              <span className="block text-[11px] text-muted-foreground">
                {enabledCount} of {NOTIFY_ROWS.length} on, brief at {prefs?.coach_time ?? '07:30'}
              </span>
            </span>
            <ChevronRight className="h-4 w-4 shrink-0 text-muted-foreground" />
          </Link>
          <Link
            ...
            className="flex items-center gap-3 px-3 py-3.5 transition-smooth active:scale-[0.99]"
          >
            <Bell className="h-4.5 w-4.5 shrink-0 text-primary" />
