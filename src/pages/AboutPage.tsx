...
import { Block, PageHeader, CtaCard, problems } from '@/lib/marketing';
...
const AboutPage = () => (
  <div className="mx-auto max-w-5xl px-4 py-8 sm:px-5 sm:py-10">
    ...
    {/* Modules */}
    <Block title="Everything it keeps" subtitle="Seven life modules. The Assistant decides where each memory belongs.">
