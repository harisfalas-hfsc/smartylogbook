...
export const plans = [
  ...
  },
  {
    ...
    cta: 'See Assistant plans',
    featured: true,
    tagline: 'Three conversation plans: Insight, Intelligence, Genius.',
  },
];
...
export const faqs = [
  ...
  { q: 'What does it cost?', a: 'The logbook is free forever and unlimited — notes, documents, photos, receipts, reminders, timeline and search. Smarty Assistant is the premium intelligence layer: Smarty Insight €6.99, Smarty Intelligence €9.99 and Smarty Genius €12.99 per month, each including a monthly allowance of AI Conversations.' },
  { q: 'What is an AI Conversation?', a: 'One complete interaction with Smarty Assistant on a single topic — comparing two blood tests, planning a workout, analysing spending, summarising a document — including the natural follow-up questions that belong to it. Anything answered by search, filters or calculations alone never uses your allowance.' },
  { q: 'Can I cancel or change plan?', a: 'Yes, any time. Prices are in euros and your data stays yours and exportable whatever plan you are on — the logbook itself never expires.' },
