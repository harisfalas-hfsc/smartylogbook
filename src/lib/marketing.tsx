...
export const faqs = [
  ...
  { q: 'What does it cost?', a: 'The logbook is free forever and unlimited — notes, documents, photos, receipts, reminders, timeline and search. Smarty Assistant is the premium intelligence layer: €9.99 per month, including 300 AI Conversations — around 10 every day. Run out and you simply wait for your renewal date, or renew immediately and your cycle restarts that day.' },
