...
export const plans = [
  {
    ...
    tagline: 'A taste of the logbook before you commit.',
  },
  {
    name: 'Smarty Premium',
    price: '€9.99',
...
export const faqs = [
  ...
  { q: 'What does it cost?', a: 'One membership: Smarty Premium, €9.99 per month, unlimited captures, 30 day Trash and Smarty Assistant with 300 AI Conversations, around 10 every day. A free account lets you try one capture in each category, with no Assistant, and deleting is permanent.' },
  { q: 'What is an AI Conversation?', a: 'One complete interaction with Smarty Assistant about your logbook on a single topic, comparing two blood tests, analysing spending, summarising a document, including the natural follow-up questions that belong to it. Capturing, classifying, searching, filtering and reminders never use your allowance, and questions outside your logbook are declined and not counted.' },
